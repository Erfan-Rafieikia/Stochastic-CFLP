...
def solve_stochastic_cflp(dat: Data, write_mp_lp=False) -> Solution:
    """
    ...
    with Model("FLP_Master") as mod:
        ...
        # cost from facilities to customers. One for each scenario
        eta = mod.addVars(dat.S,name="eta")

        # Set the objective function: minimize the sum of fixed costs and average of eta over scenarios
